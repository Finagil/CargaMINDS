...
Namespace Minds2DSTableAdapters
    ...
    Partial Public Class layoutsCuentaTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(3).CommandText = "UPDATE       layoutsCuenta"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET                MontoMensual = ?"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (No"& _ 
                "_Cuenta = ?)"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, false)>  _
        Public Overloads Overridable Function UpdateMensualidad(ByVal MontoMensual As Global.System.Nullable(Of Decimal), ByVal Original_No_Cuenta As String) As Integer
            ...
            If (Original_No_Cuenta Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_No_Cuenta")
            Else
                command.Parameters(1).Value = CType(Original_No_Cuenta,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = command.Connection.State
            If ((command.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
